...
const Navbar = () => {
	...
	return (
		<>
			<nav className="flex w-full justify-between bg-[#ffffff05] border-b border-[#ffffff4d] xl:gap-0 gap-2 relative backdrop-blur-xl px-6 md:px-12 xl:px-20 py-4 sm:py-5 lg:py-6">
